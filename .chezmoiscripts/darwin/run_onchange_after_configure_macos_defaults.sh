...
# Set the icon size of Dock items (~48 default)
...
# defaults read -g InitialKeyRepeat 2>/dev/null || echo "no set (default ≈ 25)"
# defaults read -g KeyRepeat 2>/dev/null || echo "no set (default ≈ 6)"
# delay
