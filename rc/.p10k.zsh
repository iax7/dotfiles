# Generated by Powerlevel10k configuration wizard on 2022-11-15 at 00:42 CST.
...
() {
  ...
  ##############[ nvm: node.js version from nvm (https://github.com/nvm-sh/nvm) ]###############
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=28
  # Custom icon.
  typeset -g POWERLEVEL9K_NVM_VISUAL_IDENTIFIER_EXPANSION='' # nf-mdi-language_javascript
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_RVM_VISUAL_IDENTIFIER_EXPANSION='' # nf-dev-ruby_rough
